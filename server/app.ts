 ...
 *
 * App Express com TODAS as rotas de API. Este módulo NÃO conhece o Vite nem
 * arquivos estáticos — é o que a função serverless da Vercel carrega
 * (api/index.ts). O server.ts local o reaproveita e acrescenta o dev server.
 */
